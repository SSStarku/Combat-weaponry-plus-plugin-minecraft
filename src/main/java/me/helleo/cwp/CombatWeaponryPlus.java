...
//	}
    ...
    public SmithingRecipe getprisswordsrecipe() {
        // Ensure a valid result (a sword, for example)
        ItemStack result = new ItemStack(Material.DIAMOND_SWORD); // This is just an example. Use the material you need.
    
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_sword"),
            result, // valid result
    ...
    public SmithingRecipe getprispickrecipe() {
        // Define a valid result item (e.g., a prismarine pickaxe or something else)
        ItemStack result = new ItemStack(Material.DIAMOND_PICKAXE);  // Example result (use the material you want)
    
        // Create the Smithing recipe for the prismarine pickaxe transformation
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_pick"),  // Unique NamespacedKey for the recipe
            result,  // Valid result (diamond pickaxe, or whatever you choose)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template (Lapis Lazuli)
            new RecipeChoice.MaterialChoice(Material.NETHERITE_PICKAXE),  // Base (Netherite Pickaxe)
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add (Prismarine Shard)
        );
    ...
    public SmithingRecipe getprisaxerecipe() {
        // Valid result: ItemStack must be a non-empty material
        ItemStack result = new ItemStack(Material.DIAMOND_AXE);  // Replace with the appropriate item (e.g., Diamond Axe)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_axe"),
            result,  // Valid result item (Diamond Axe in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_AXE),  // Base: Netherite Axe
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
    ...
    public SmithingRecipe getprisshovelrecipe() {
        // Valid result: ItemStack must be a non-empty material
        ItemStack result = new ItemStack(Material.DIAMOND_SHOVEL);  // Replace with the appropriate item (e.g., Diamond Shovel)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_shovel"),
            result,  // Valid result item (Diamond Shovel in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_SHOVEL),  // Base: Netherite Shovel
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
    ...
    public SmithingRecipe getprishoerecipe() {
        // Valid result: ItemStack must be a non-empty material
        ItemStack result = new ItemStack(Material.DIAMOND_HOE);  // Replace with the appropriate item (e.g., Diamond Hoe)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_shoe"),
            result,  // Valid result item (Diamond Hoe in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_HOE),  // Base: Netherite Hoe
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
    ...
    public SmithingRecipe getprishelmetrecipe() {
        // Valid result: ItemStack must be a non-empty material
        ItemStack result = new ItemStack(Material.DIAMOND_HELMET);  // Replace with the appropriate item (e.g., Diamond Helmet)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_helmet"),
            result,  // Valid result item (Diamond Helmet in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_HELMET),  // Base: Netherite Helmet
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
    ...
    public SmithingRecipe getprischestrecipe() {
        // Valid result: ItemStack must be a non-empty material
        ItemStack result = new ItemStack(Material.DIAMOND_CHESTPLATE);  // Replace with the appropriate item (e.g., Diamond Chestplate)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_chest"),
            result,  // Valid result item (Diamond Chestplate in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_CHESTPLATE),  // Base: Netherite Chestplate
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
    ...
    public SmithingRecipe getprislegrecipe() {
        // Valid result: ItemStack must be a non-empty material
        ItemStack result = new ItemStack(Material.DIAMOND_LEGGINGS);  // Replace with appropriate material (e.g., Diamond Leggings)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_leg"),
            result,  // Valid result item (Diamond Leggings in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_LEGGINGS),  // Base: Netherite Leggings
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
    ...
    public SmithingRecipe getprisbootsrecipe() {
        // Valid result: Replace Material.AIR with a valid item like Diamond Boots or Netherite Boots
        ItemStack result = new ItemStack(Material.DIAMOND_BOOTS);  // Replace with the desired boots material (e.g., Diamond Boots)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "pris_boots"),
            result,  // Valid result item (Diamond Boots in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_BOOTS),  // Base: Netherite Boots
            new RecipeChoice.MaterialChoice(Material.PRISMARINE_SHARD)  // Add: Prismarine Shard
        );
...
//					player.getInventory().getItemInMainHand().setItemMeta(meta);
    ...
    public SmithingRecipe getawakswordsrecipe() {
        // Valid result: Replace Material.AIR with a valid item like Diamond Sword or Netherite Sword
        ItemStack result = new ItemStack(Material.DIAMOND_SWORD);  // Replace with the desired sword material (e.g., Diamond Sword)
    
        // Creating the SmithingTransformRecipe with a valid result
        SmithingRecipe recipe = new SmithingTransformRecipe(
            new NamespacedKey(this, "tesfergvergtt"),
            result,  // Valid result item (Diamond Sword in this case)
            new RecipeChoice.MaterialChoice(Material.LAPIS_LAZULI),  // Template: Lapis Lazuli
            new RecipeChoice.MaterialChoice(Material.NETHERITE_SWORD),  // Base: Netherite Sword
            new RecipeChoice.MaterialChoice(Material.NETHERITE_SWORD)  // Add: Netherite Sword (you may want to use another item here)
        );
